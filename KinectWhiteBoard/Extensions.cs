...
namespace KinectWhiteBoard
{
    public static class Extensions
    {
        ...
        private static Ellipse ellipseLeft = new Ellipse
        {
            Width = 100,
            Height = 100,
        ...
        private static Ellipse ellipseRight = new Ellipse
        {
            Width = 100,
            Height = 100,
            Stroke = new SolidColorBrush(Colors.LightSalmon),
            StrokeThickness = 4
        };
        ...
        public static void DrawHand(this Canvas canvas, Joint hand, bool isLeft)
        {
